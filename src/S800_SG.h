...
class S800FpTrack : public TObject {
 ...
 public:
  ...
  void GetThetaPhi(double ata0, double bta0, int z, int a);
...
class S800
{
 ...
 public:
  ...
  S800(TRandom* ran, histo_sort * Histo0, histo_read * Histo1);
  void Reset();
  ~S800();
  ...
  int CRDC0Runs[5] = {23,88,181,311,351};
  int CRDC1Runs[5] = {24,89,182,312,352};
  float CRDCSlope[2][2][5]; //[CRDC][X or Y]
  float CRDCOffset[2][2][5];
