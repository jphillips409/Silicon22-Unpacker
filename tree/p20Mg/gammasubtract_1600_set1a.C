void gammasubtract_1600_set1a()
{
  ...
  TH1I * Nogamma = (TH1I*) f->Get("SortCode/Erel_21Al_p20Mg_set1a")->Clone(Form("Nogamma"));
  TH1I * with = (TH1I*) f->Get("SortCode/Erel_21Al_p20Mg_with1600_set1a")->Clone(Form("with1600"));
