...
TCanvas canvas("Vcm");
  ...
  TFile f("sort.root");
  TH1I * Vcm_B = (TH1I*) f.Get("SortCode/VCM_21Al_p20Mg");
  Vcm_B->GetXaxis()->SetRangeUser(12,14);
  ...
  TF1 *g1 = new TF1("g1", "gaus",12.4, 12.9);
  TF1 *g2 = new TF1("g2", "gaus", 12.9, 13.2);

  TF1 *total = new TF1("total", "gaus(0)+gaus(3)", 12.4, 13.2);
