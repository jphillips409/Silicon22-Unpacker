void gammasubtract_add()
{
  //For gamma region to the left of 1600 keV peak
  gROOT->Reset();
  ...
  TH1I * with = (TH1I*) f->Get("SortCode/Erel_21Al_p20Mg_left1600")->Clone(Form("with"));
  TH1I * with1 = (TH1I*) f->Get("SortCode/Erel_21Al_p20Mg_right1600")->Clone(Form("with1"));
  ...
  with_cop->GetYaxis()->SetRangeUser(0,80);
  ...
  Nogamma->GetYaxis()->SetRangeUser(0,80);
  ...
  with->Add(Nogamma,-1);
  mycan->cd(4);
  with->GetYaxis()->SetRangeUser(0,80);
