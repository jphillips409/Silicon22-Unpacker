void gammasubtract_withgamma()
{
  ...
  TH1I * with = (TH1I*) f->Get("SortCode/Erel_21Al_p20Mg_withgamma")->Clone(Form("Erel_21Al_p20Mg_withgamma"));
  ...
  with_cop->GetYaxis()->SetRangeUser(0,400);
  ...
  Nogamma->GetYaxis()->SetRangeUser(0,400);
  ...
  with->Add(Nogamma,-1);
  mycan->cd(4);
  with->GetYaxis()->SetRangeUser(0,50);
